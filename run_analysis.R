...
setwd("C:/Users/dbrow/datasciencecoursera/Getting and Cleaning Data/UCI HAR Dataset/test")
...
setwd("C:/Users/dbrow/datasciencecoursera/Getting and Cleaning Data/UCI HAR Dataset/train")
x_train <- read.table("x_train.txt", sep = "")
y_train <- read.table("y_train.txt", sep = "")
train_subjects <- read.table("subject_train.txt", sep = "")

##read in activity labels
setwd("C:/Users/dbrow/datasciencecoursera/Getting and Cleaning Data/UCI HAR Dataset")
